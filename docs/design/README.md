...
| [PEER-WATCH/](PEER-WATCH/README.md) | **Взаимный дозор нод**: ноды пингуют друг друга, ‼️ на падение, ⚠️ на деградацию, суточная сводка. Отдельный бот-дозорный только на отправку, настройки едут по кластеру. Что уже есть — [guide/PEER-HEALTH.md](../guide/PEER-HEALTH.md) | `lib/cluster.sh`, `lib/notify.sh`, `lib/cron.sh`, `hy2-manager.sh` |
