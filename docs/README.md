...
| [research/](research/README.md) | Заметки про децентрализованный маркет локаций. **Не план работ** | Думаешь про внешний контур и чужие ноды |
...
| `docs/01…07`, `docs/11-transition.md` | [research/](research/README.md) под теми же именами |
