...
| [CLUSTER.md](CLUSTER.md) | Обмен между нодами, жизненный цикл профиля, подписка | 23 |
...
| [OPS.md](OPS.md) | Гонки кронов, отдача данных наружу, мелочи | 24 |
...
| [P-122](PROTOCOLS.md#p-122) | Клиентский конфиг резолвил домен ноды открытым UDP — перехват на транзите | `lib/users.sh` | [protocols](PROTOCOLS.md) | ✅ |
| [P-123](OPS.md#p-123) | Уведомление, которому некому уйти, терялось молча | `lib/notify.sh` | [ops](OPS.md) | ✅ |
| [P-126](OPS.md#p-126) | Ссылка из директа канала вела в «код неверен» | `lib/tgbot_daemon.sh` | [ops](OPS.md) | ✅ |
| [P-129](PROTOCOLS.md#p-129) | REALITY маскировался чужим популярным доменом — бан адреса ноды | `lib/protocols.sh` | [protocols](PROTOCOLS.md) | ✅ |
...
Следующий свободный номер — **P-133**.
