...
| [OPS.md](OPS.md) | Гонки кронов, отдача данных наружу, мелочи | 7 |
...
| [P-46](OPS.md#p-46) | Открытый TUI публикует статистику своим — старым — кодом | `lib/ui_users.sh`, `lib/cluster.sh` | [ops](OPS.md) | 🔴 |

Следующий свободный номер — **P-47**.
