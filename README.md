...
- **Конфиг для sing-box** — генерация клиентского JSON-конфига sing-box (TUN полный туннель + DNS + outbound hysteria2): вывод на экран и сохранение во временный файл (mode 600)
