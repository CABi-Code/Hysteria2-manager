...
- **Конфиг для sing-box** — генерация клиентского JSON-конфига sing-box (inbound mixed + outbound hysteria2): вывод на экран и сохранение во временный файл (mode 600)
